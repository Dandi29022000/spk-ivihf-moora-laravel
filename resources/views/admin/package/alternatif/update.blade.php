                ...
                <div class="card-body">
                    ...
                    <form action="/admin/alternatif/formedit/updatealternatif/{id}" method="post">
                        ...
                        <div class="input-group">
                            <label for="id" class="col-md-4 col-form-label text-md-end">{{ __('Id Alternatif') }}</label>
                            <input class="form-control" name="id" placeholder="Id Alternatif" type="text" value="{{ $DK->id }}" readonly>
                        </div>
                        <br>
                        <div class="input-group">
                            <label for="code" class="col-md-4 col-form-label text-md-end">{{ __('Kode Alternatif') }}</label>
                            <input class="form-control" name="code" placeholder="Kode Alternatif" type="text" value="{{ $DK->code }}">
                        </div>
                        <br>
                        <div class="input-group">
